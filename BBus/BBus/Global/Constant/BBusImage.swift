...
enum BBusImage {
    ...
    static let blueBooduckBus = UIImage(named: "blueBusWithBooduck")
    static let redBooduckBus = UIImage(named: "redBusWithBooduck")
    static let greenBooduckBus = UIImage(named: "greenBusWithBooduck")
    static let circulationBooduckBus = UIImage(named: "circulationBusWithBooduck")
